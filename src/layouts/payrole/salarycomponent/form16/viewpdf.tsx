            ...
            <table style={tableStyle}>
              <tbody>
                ...
                <tr>
                  ...
                  <td style={tdStyle}>
                    Amount of any other exemption under section 10 [Note:
                    Break-up to be filled and signed by employer in the table
                ...
                <tr>
                  <td style={tdStyle}>(a)</td>
                  <td style={tdStyle}>
                    Standard deduction under section 16(a)
                  </td>
                  <td style={tdStyle}></td>
                  <td style={tdStyle}>
                ...
                <tr>
                  <td style={tdStyle}>(a)</td>
                  <td style={tdStyle}>
                    Deduction in respect of life insurance premia, contributions
                ...
                <tr>
                  ...
                  <td style={tdStyle}>
                    ...
                    VI-A [Note: Break-up to be filled and signed by employer in
                    the table provide at the bottom of this form]
                  </td>
                ...
                <tr>
                  ...
                  <td style={tdStyle}>
                    Total of amount deductible under any other provision of
                    Chapter VI-A
                  </td>
                  <td style={tdStyle}>0</td>
                  <td style={tdStyle}>0</td>
