...
export const organisationSchema = Yup.object({
  ...
  dept_code: Yup.string()
    .min(2)
    .max(25)
    .required("Please enter your dept_code"),
  ...
  organization_name: Yup.string()
    .min(2)
    .max(25)
    .required("Please enter your organization_name"),
  location: Yup.string().min(2).max(25).required("Please enter your location"),
  organization_type: Yup.string()
    .min(2)
    .max(25)
    .required("Please enter your organization_type"),
  employee_type: Yup.string()
    .min(2)
    .max(25)
    .required("Please enter your employee_type"),
  state: Yup.string().min(2).max(25).required("Please enter your state"),
  location_name: Yup.string()
    .min(2)
    .max(25)
    .required("Please enter your location_name"),
  add_line2: Yup.string()
    .min(2)
    .max(25)
    .required("Please enter your add_line2"),
  add_line1: Yup.string()
    .min(2)
    .max(25)
    .required("Please enter your add_line1"),
  ...
  source_of_hire: Yup.string()
    .min(2)
    .max(25)
    .required("Please enter your source_of_hire"),
