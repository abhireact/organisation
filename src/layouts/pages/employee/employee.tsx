...
const Employee = () => {
  ...
  const handleFormSubmit = async () => {
    try {
      ...
      const response = await axios.post(`${process.env.REACT_APP_BACKEND_URL}/employee`, values, {
        headers: {
          "Content-Type": "application/json",
          Authorization: `Bearer ${token}`,
        },
...
// " "    <Grid item xs={12} sm={9}>
// <MDTypography variant="h6">{"Salary Details"}</MDTypography>
// </Grid>
...
// <MDTypography>Annual CTC</MDTypography>
// <Input
//   addonBefore="₹"
//   addonAfter="per year"
//   defaultValue="50%"
...
//   onChange={handleChange}
//   onBlur={handleBlur}
//   // error={errors.annual_ctc && touched.annual_ctc}
//   // success={values.annual_ctc.length && !errors.annual_ctc}
// />
// {errors.annual_ctc && touched.annual_ctc ? (
//   // <p classannual_ctc="form-error">{errors.annual_ctc}</p>
//   <MDTypography variant="caption" fontWeight="regular" color="error">
//     {errors.annual_ctc}
//   </MDTypography>
// ) : null}
...
//   // multiple
//   onChange={(event: any, value: any) => {
//     handleChange({ target: { annual_ctc: "role", value } });
//   }}
//   // value={department}
//   // onChange={handleMainFieldChange}
...
//   type="number"
//   name="percentofctc"
//   value={values.percentofctc}
//   onChange={handleChange}
//   onBlur={handleBlur}
//   // error={errors.percentofctc && touched.percentofctc}
//   // success={values.percentofctc.length && !errors.percentofctc}
// />
// {errors.percentofctc && touched.percentofctc ? (
//   // <p classpercentofctc="form-error">{errors.percentofctc}</p>
//   <MDTypography variant="caption" fontWeight="regular" color="error">
//     {errors.percentofctc}
//   </MDTypography>
// ) : null}
...
//   onChange={handleChange}
//   onBlur={handleBlur}
//   // error={errors.monthlybasicsalary && touched.monthlybasicsalary}
//   // success={values.monthlybasicsalary.length && !errors.monthlybasicsalary}
// />
// {errors.monthlybasicsalary && touched.monthlybasicsalary ? (
//   // <p classmonthlybasicsalary="form-error">{errors.monthlybasicsalary}</p>
//   <MDTypography variant="caption" fontWeight="regular" color="error">
//     {errors.monthlybasicsalary}
//   </MDTypography>
// ) : null}
// </Grid>
// <Grid item xs={12} sm={3} mt={2}>
...
// >
//   {values.annual_ctc && values.percentofctc
//     ? (values.percentofctc / 100) * values.annual_ctc
//     : 0}
// </MDTypography>
// {/* <Input
// addonAfter="% of CTC"
...
//   type="number"
//   name="percentofbasic"
//   value={values.percentofbasic}
//   onChange={handleChange}
//   onBlur={handleBlur}
//   // error={errors.percentofbasic && touched.percentofbasic}
//   // success={values.percentofbasic.length && !errors.percentofbasic}
// />
// {errors.percentofbasic && touched.percentofbasic ? (
//   // <p classpercentofbasic="form-error">{errors.percentofbasic}</p>
//   <MDTypography variant="caption" fontWeight="regular" color="error">
//     {errors.percentofbasic}
//   </MDTypography>
// ) : null}
// </Grid>
// <Grid item xs={12} sm={3} mt={2}>
...
//   type="number"
//   name="name"
//   value={values.percentofbasic ? (values.percentofbasic / 100) * ctcbasic : 0}
//   onChange={handleChange}
//   onBlur={handleBlur}
//   // error={errors.name && touched.name}
//   // success={values.name.length && !errors.name}
...
//   sx={{ marginLeft: -2 }}
// >
//   {values.percentofbasic ? (values.percentofbasic / 100) * 12 * ctcbasic : 0}
// </MDTypography>
// </Grid>
// <Grid item xs={12} sm={3} mt={2}>
// <MDTypography
...
//   defaultValue="50%"
//   type="number"
//   name="convinienceallownce"
//   value={values.convinienceallownce}
//   onChange={handleChange}
//   onBlur={handleBlur}
//   // error={errors.convinienceallownce && touched.convinienceallownce}
//   // success={values.convinienceallownce.length && !errors.convinienceallownce}
// />
// {errors.convinienceallownce && touched.convinienceallownce ? (
//   // <p classconvinienceallownce="form-error">{errors.convinienceallownce}</p>
//   <MDTypography variant="caption" fontWeight="regular" color="error">
//     {errors.convinienceallownce}
//   </MDTypography>
// ) : null}
// </Grid>
// <Grid item xs={12} sm={3} mt={2}>
