...
export default function DistributionReport() {
  ...
  //             "/employee/report/filter/department",
  //             values,
  //             {
  //               headers: {
  //                 "Content-Type": "application/json",
  ...
  const handleFormSubmit = async () => {
    try {
      ...
      if (selectedOption === "department") {
        response = await axios.post(
          `${process.env.REACT_APP_BACKEND_URL}/employee/report/filter/department`,
          values,
          {
            headers: {
              "Content-Type": "application/json",
        ...
        response = await axios.post(
          `${process.env.REACT_APP_BACKEND_URL}/employee/report/filter/designation`,
          values,
          {
            headers: {
              "Content-Type": "application/json",
        ...
        response = await axios.post(
          `${process.env.REACT_APP_BACKEND_URL}/employee/report/filter/location`,
          values,
          {
            headers: {
              "Content-Type": "application/json",
